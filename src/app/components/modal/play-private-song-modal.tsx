...
export default function PlayPrivateSongModal({ isOpen, onClose, songTitle, songArtist }: Props) {
      ...
      >
        ...
        >
          ...
          <div style={{ marginBottom: "24px", padding: "16px", backgroundColor: "#f3f4f6", borderRadius: "8px" }}>
            <p style={{ margin: 0, fontWeight: "500", fontSize: "14px" }}>{songTitle}</p>
            <p style={{ margin: "4px 0 0 0", color: "#6b7280", fontSize: "14px" }}>{songArtist}</p>
          </div>
